...
const featureSequence = [
    { imagePath: "/performance1.webp", boxClass: ".box1", delay: 1 },
    { imagePath: "/performance2.webp", boxClass: ".box2", delay: 0 },
    { imagePath: "/performance3.webp", boxClass: ".box3", delay: 0 },
    { imagePath: "/performance4.webp", boxClass: ".box4", delay: 0 },
    { imagePath: "/performance5.webp", boxClass: ".box5", delay: 0 },
];
